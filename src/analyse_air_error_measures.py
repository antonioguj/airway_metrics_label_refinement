...
from common.genererrors import get_norm_vector
...
def main(args):
    ...
    list_input_air_error_measures_files = list_files_dir(args.input_dir, '*.csv')
    ...
    for in_air_error_measures_file in list_input_air_error_measures_files:
        print("\nInput: \'%s\'..." % (basename(in_air_error_measures_file)))
        in_casename = get_casename_filename(in_air_error_measures_file)
        ...
        in_air_error_measures = CsvFileReader.get_data(in_air_error_measures_file)

        in_airway_measures = CsvFileReader.get_data(in_airway_measures_file)

        in_airway_ids_air_errors = in_air_error_measures['airway_id']
        in_type_error_air_errors = in_air_error_measures['type_error']
        in_length_blank_air_errors = in_air_error_measures['length_blank']

        in_airlength_branches = in_airway_measures['airway_length']
